...
function RegisterRule({ goal }) {
  ...
  const [cycle, setCycle] = useState(31);
                      ...
                      <div style={{ textAlign: "left" }}>
                        <button
                          ...
                          className={`text-primary btn-neutral ml-1 btn btn-primary ${
                            account === registerWAccount ? "active" : ""
                          }`}
                        >
                          <table style={{ marginRight: "auto" }}>
                            <tr>
                              <th rowSpan="2">
                                <span>{bankLogo(account.bankName)}</span>
                              </th>
                              <th
                                style={{
                                  fontSize: "12px",
                    ...
                    savingAccounts.map((account) => (
                      <div style={{ textAlign: "left" }}>
                        <button
                          ...
                          className={`text-primary btn-neutral ml-1 btn btn-primary ${
                            account === registerSAccount ? "active" : ""
                          }`}
                        >
                          <table style={{ marginRight: "auto" }}>
                            <tr>
                    ...
                    <LocalizationProvider dateAdapter={AdapterDayjs}>
                      ...
                      >
                        <DemoItem>
                          <DateCalendar
                            value={savingDate}
                            onChange={(newValue) => setSavingDate(newValue)}
                            minDate={dayjs()}
                          />
                        </DemoItem>
                      </DemoContainer>
                    ...
                    <div style={{ marginTop: "10px" }}>
                      <Grid container spacing={1}>
                        <Grid item xs={15}>
                          <div style={{ textAlign: "left" }}>
                            <p>
                              {savingDate.format("YYYY년 MM월 DD일").toString()}
                              부터 매월 {cycle}일, {money}원씩 저축해요. (예상
                              목표 달성 기간 :{" "}
                              {Math.ceil(goal.goalAmount / money)}개월)
                            </p>
                          </div>
                        </Grid>
                      </Grid>
                      ...
                      >
                        ...
                        <table style={{ marginRight: "auto" }}>
                          <tr>
                            <th rowSpan="2">
                              <span>{bankLogo(registerWAccount.bankName)}</span>
                            </th>
                            <th
                              style={{
                                fontSize: "12px",
